...
public class ScoreDataShowManageInterFrame extends JInternalFrame {
...
private JTable scoreDataTable;
	 ...
	 * Create the frame.
	 */
	public ScoreDataShowManageInterFrame() {
		setResizable(true);
		setIconifiable(true);
		setClosable(true);
		setTitle("Score Data Management");
		setBounds(100, 100, 609, 496);
		...
		JButton btnNewButton = new JButton("Search Show");
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
							...
							.addComponent(s_movieTitleTxt, GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
							.addGap(18)
		...
		JLabel lblNewLabel_4 = new JLabel("Vote: ");
		lblNewLabel_4.setFont(new Font("Times New Roman", Font.BOLD, 14));
		
		voteTxt = new JTextField();
		voteTxt.setColumns(10);
				...
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(voteTxt, GroupLayout.PREFERRED_SIZE, 89, GroupLayout.PREFERRED_SIZE)
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(voteTxt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
	...
	private void ScoreDataUpdateActionEvent(ActionEvent e) {
		...
		if (StringUtil.isEmpty(vote)) {
			JOptionPane.showMessageDialog(null, "Vote Cannot be Empty!");
			return;
		}
		
		ScoreData scoreData = new ScoreData(id, Double.parseDouble(score), Integer.parseInt(vote));
		Connection con = null;
		try {
			con = dbUtil.getCon();
	...
	private void ScoreDataTableMousePressed(MouseEvent event) {
		...
		voteTxt.setText((String)scoreDataTable.getValueAt(row, 3));
	}
	 ...
	 * @param scoreData
	 */
	private void fillTable(ScoreData scoreData, String showTitle) {
		DefaultTableModel dtm = (DefaultTableModel) scoreDataTable.getModel();
		dtm.setRowCount(0);
		Connection con = null;
		try {
			con = dbUtil.getCon();
			ResultSet rs = scoreDataDao.list2(con, scoreData, showTitle);
			while(rs.next()) {
				Vector v = new Vector();
