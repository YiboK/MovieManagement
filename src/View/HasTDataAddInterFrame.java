...
public class HasTDataAddInterFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HasTDataAddInterFrame frame = new HasTDataAddInterFrame();
	 ...
	 * Create the frame.
	 */
	public HasTDataAddInterFrame() {
		setTitle("Add Show-Score Relation");
		setIconifiable(true);
		setClosable(true);
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(showIDTxt, GroupLayout.PREFERRED_SIZE, 193, GroupLayout.PREFERRED_SIZE)
	 ...
	 * @param e
	 */
	private void hasTDataAddActionPerformed(ActionEvent e) {
		...
		HasTData hasTData = new HasTData(showID, scoreID);
		Connection con = null;
		try {
			con = dbUtil.getCon();
			int n = hasTDataDao.add(con, hasTData);
			if (n == 1) {
				JOptionPane.showMessageDialog(null, "Show-Score Relation Successfully Add To Database!");
				resetValue();
			} else {
				JOptionPane.showMessageDialog(null, "Show-Score Relation Addition Failed!");
			}
		} catch(Exception e1) {
			e1.printStackTrace();
			JOptionPane.showMessageDialog(null, "Show-Score Relation Addition Failed!");
